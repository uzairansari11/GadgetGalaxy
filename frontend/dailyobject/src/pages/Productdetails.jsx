...
export const ProductDetails = () => {
	...
	useEffect(() => {
		axios
			.get(`https://gadgetgalaxy.cyclic.app/products/${x}`)
			...
			<Box>
                ...
                <Box>
                    <Image src={data.Image2} />
						...
						<Box>
							...
							<Text m="auto" mt="3%" fontSize="xl" fontWeight={"400"} w="70%">
					...
					<Box w="50%" mt={{ lg: "8%", md: "1%" }}>
						<Box>
							...
							<Box display={"flex"} mt="2%">
								<Text fontSize={"2xl"} ml="18%" fontWeight="500">
				...
				>
					...
					>
						...
						<Text mt="5%" textAlign={"center"}>
							Bag is really aesthetic, holds "khatarnaak" quality, easily
							washable. Happy with the purchase.
						</Text>
					</Box>
					<Box
						mb="30px"
